...
export default function ActionsPage({ params }: { params: Promise<{ category: string; sop: string }> }) {
  ...
  if (selectedTask) {
    return <TaskDetail task={selectedTask} app={app} stage="actions" onBack={() => setSelectedTask(null)} />;
  }

  return <TaskTable tasks={tasks} filterStage="actions" onSelectTask={setSelectedTask} selectedTaskId={undefined} />;
}
