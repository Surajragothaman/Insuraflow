...
export default function IntakePage({ params }: { params: Promise<{ category: string; sop: string }> }) {
  ...
  if (selectedTask) {
    return <TaskDetail task={selectedTask} app={app} stage="intake" onBack={() => setSelectedTask(null)} />;
  }

  return <TaskTable tasks={tasks} filterStage="intake" onSelectTask={setSelectedTask} selectedTaskId={undefined} />;
}
