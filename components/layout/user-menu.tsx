  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          type="button"
          className="flex items-center gap-2 pl-4 pr-4 sm:pr-6 lg:pr-8 h-full border-l border-border cursor-pointer hover:bg-accent/50 transition-colors select-none focus:outline-none"
        >
